...
2. Source overlay
   ...
   ```
3. Run launch file to start nodes
   ```sh
   cd launch
   ros2 launch start.launch.py XXX.XXX.XXX.XXX NAME_OF_ROBOT 
   ```
   Fill X's with Robot IP Address and add robot name. This only works for 1 robot at a time
