...
def open_camera(index: int):
    ...
    # Discard several frames so auto-exposure has time to converge and the
    # hardware finishes initialising.  Grabbing immediately after CameraPlay
    # causes a timeout (error -12 / CAMERA_STATUS_TIME_OUT).
